...
The code is on GitHub: [github.com/zhen0/meal-planner](https://github.com/zhen0/meal-planner). If you're dealing with similar cognitive load around routine tasks, automation might be worth the effort—not necessarily to save time, but to reclaim mental space for things that actually matter.
